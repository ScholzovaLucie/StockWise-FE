      ...
      >
        <Stack spacing={4} alignItems="center">
          ...
          <Typography variant="h6" color="text.secondary" sx={{ maxWidth: "80%" }}>
            Inteligentní správa skladu poháněná chatbotem. Komunikujte přirozeně, 
            spravujte zásoby hlasem nebo textem a optimalizujte skladové procesy snadno a efektivně.
          </Typography>
          <Stack direction="row" spacing={2}>
            <Button href="/auth/login" variant="contained" color="primary" size="large">
              Přihlášení
            </Button>
